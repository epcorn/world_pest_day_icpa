module.exports = function generateQuizCertificateHTML(
  ...
  const safeAnnotation =
    annotation && annotation.trim() ? annotation.trim() : "";
  const safeName = name && name.trim() ? name.trim() : "Unknown Participant";
  const safeCompanyName =
    companyName && companyName.trim() ? companyName.trim() : "N/A";
  const safeIssueDate =
  ...
  const vpSigUrl =
    "https://res.cloudinary.com/dbzucdgf0/image/upload/v1748840827/IPCA_VP_SIGN_chsync.png";
  const secretarySigUrl =
    "https://res.cloudinary.com/dbzucdgf0/image/upload/v1748840804/IPCA_SECRETARY_SIGN_qr62py.png";
  const presidentSigUrl =
    "https://res.cloudinary.com/dbzucdgf0/image/upload/v1748840796/IPCA_PRESIDENT_SIGN_tnotye.png";
  const logoUrl =
    "https://res.cloudinary.com/dbzucdgf0/image/upload/v1748840762/IPCA_LOGO_ckfv6q.jpg";
  // -----------------------------------------------------------
