        ...
        <div className="flex flex-col sm:flex-row justify-between items-center mb-6 sm:mb-8">
          ...
          <div className="flex space-x-3">
            <button
              ...
              className={`px-5 py-2 rounded-lg shadow-md transition duration-300 ease-in-out font-medium text-base transform hover:scale-105 flex items-center ${showAnalytics
                  ...
                  >
                    ...
                    <div className="md:ml-auto self-stretch flex flex-col space-y-3 w-full sm:w-auto mt-4 md:mt-0">
                      <button
                        ...
                        className={`w-full px-5 py-2 rounded-md shadow-sm transition duration-300 ease-in-out font-semibold text-base flex items-center justify-center ${approving[_id]
