...
const PrizingPage = () => {
  return (
    <div className="p-4 sm:p-6 lg:p-8 bg-gray-50 min-h-screen flex flex-col items-center justify-center">
      <div className="bg-white rounded-xl shadow-lg p-6 sm:p-8 md:p-10 max-w-5xl w-full text-center border-t-8 border-yellow-400">
        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-blue-800 mb-6 sm:mb-8 flex items-center justify-center space-x-2 sm:space-x-3">
          <Award size={36} className="text-yellow-500 sm:size-48" />
        ...
        <p className="text-sm sm:text-base text-gray-600 mt-8 sm:mt-10">
...
const TopicCard = ({ title, icon: Icon }) => {
  return (
    <div className="bg-gray-100 border border-gray-200 rounded-lg p-4 sm:p-5 shadow-sm flex flex-col items-center hover:shadow-md transition-shadow duration-300">
      <Icon size={28} className="mb-2 text-blue-500" />
